...
namespace Tangy.Controllers
{
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var cart = _db.ShoppingCart.Where(c => c.ApplicationUserId.Equals(claim.Value));
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count == 1)
            {
                ...
                var cnt = _db.ShoppingCart.Where(u => u.ApplicationUserId == cart.ApplicationUserId).Count();
