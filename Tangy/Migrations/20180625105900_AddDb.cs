        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: false),
                    Picture = table.Column<byte[]>(type: "varbinary(100)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Therapist_TherapyType_TherapyTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TherapistReview", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TherapistReview_Therapist_TherapistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Therapist_TherapyTypeId",
                table: "Therapist",
                column: "TherapyTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TherapistReview_TherapistId",
                table: "TherapistReview",
                column: "TherapistId");
        }
